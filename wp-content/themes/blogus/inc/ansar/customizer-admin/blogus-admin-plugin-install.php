               ...
               <div class="blogus-notice-started updated notice notice-get-started-class is-dismissible" data-notice="get_started">
                <div class="blogus-notice clearfix">
                    <div class="blogus-notice-content">
                        ...
                        <p><?php echo printf( esc_html__("Thank you for choosing blogus theme. To take full advantage of the complete features of the theme click the Starter Sites and Install and Activate the plugin then use the demo importer and install the Blogus Demo according to your need.", "blogus") ); ?></p>
